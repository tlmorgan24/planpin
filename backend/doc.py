...
user_id = 'dc142d96-48f0-487b-8586-170b075769b5' # placeholder for testing: this is my test user ID
plan_id = '18b1d336-651f-40d8-81db-010bc991102b' # placeholder for testing: a specific A2 plan in my cloud database at time of writing
PRIORITY_LIMIT = 5 # number of "priority defects" to highlight in executive summary
INCLUDE_CAPTION = False # no caption to defect images

marker_records, priority_marker_records, marker_images = get_data(user_id, plan_id, PRIORITY_LIMIT)
...
# Save the document
doc.save("/Users/thomasmorgan/Downloads/test-doc.docx")
