    ...
    return (
        <div className="privacy-policy-container">
            ...
            <div className="privacy-policy">
                ...
                <p>Passwords used to sign up or log in are securely encrypted and not visible to PlanPin.</p>
                ...
                <p>Data is stored locally on the user's device when using the PlanPin iOS app. Data is stored in the cloud only when using the planpin.app website, or when sync is manually triggered by the user on the PlanPin iOS app. Security measures include:</p>
                <ul>
